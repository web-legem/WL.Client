<template>
  ...
  >
    <label><span class="ico2-contrast" /> {{ $t('search.controls-la.label-contrast') }}</label>
    <div>
      <button 
        id="btn-light"
    ...
    <label><span class="ico2-earth" /> {{ $t('search.controls-la.label-language') }}</label>
    <div>
      <nuxt-link
    ...
    <label><span class="ico2-font-size" /> {{ $t('search.controls-la.label-font-size') }}</label>
    <div>
      <button
